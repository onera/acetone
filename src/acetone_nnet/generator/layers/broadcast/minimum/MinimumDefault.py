...
class MinimumDefault(Minimum, Broadcast):
    ...
    def forward_path_layer(self: Self, input_arrays: np.ndarray) -> np.ndarray:
        ...
        return Minimum.forward_path_layer(self, input_arrays)

    def generate_inference_code_layer(self: Self) -> str:
        """Generate computation code for layer."""
        return Broadcast.generate_inference_code_layer(self)

def minimum_default_implementation(
        old_layer: Minimum,
        version: str,
) -> MinimumDefault:
...
minimum_factory.register_implementation(
    None,
