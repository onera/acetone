...
class SubtractDefault(Subtract, Broadcast):
    ...
    def forward_path_layer(self: Self, input_arrays: np.ndarray) -> np.ndarray:
        ...
        return Subtract.forward_path_layer(self, input_arrays)

    def generate_inference_code_layer(self: Self) -> str:
        """Generate computation code for layer."""
        return Broadcast.generate_inference_code_layer(self)

def subtract_default_implementation(
        old_layer: Subtract,
        version: str,
) -> SubtractDefault:
...
subtract_factory.register_implementation(
    None,
