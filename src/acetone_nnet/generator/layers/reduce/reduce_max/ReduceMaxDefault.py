...
from acetone_nnet.versioning.layer_factories import reduce_max_factory
...
class ReduceMaxDefault(ReduceMax, Reduce):
    ...
    def __init__(self:Self, version:str, **kwargs:Any) -> None:
        ...
        ReduceMax.__init__(self, **kwargs)
    ...
    def forward_path_layer(
        ...
        return ReduceMax.forward_path_layer(self, input_array)
...
def reduce_max_default_implementation(
        old_layer: ReduceMax,
        version: str,
) -> ReduceMaxDefault:
...
reduce_max_factory.register_implementation(
    None,
