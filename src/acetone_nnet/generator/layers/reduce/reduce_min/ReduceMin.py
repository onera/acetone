"""ReduceMin layer type definition.
    ...
    def forward_path_layer(
        ...
        if self.axes == ():
            if self.noop_with_empty_axes:
                return input_array
            return np.min(input_array, axis=None, keepdims=self.keepdims)
        return np.min(input_array, axis=self.axes, keepdims=self.keepdims)
