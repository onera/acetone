...
class ReduceMinDefault(ReduceMin, Reduce):
    """Reduce Min Default layer with default implementation class."""

    def __init__(self:Self, version:str, **kwargs:Any) -> None:
        """Build a Reduce Min Layer with default implementation."""
        ReduceMin.__init__(self, **kwargs)
    ...
    def forward_path_layer(
        ...
        return ReduceMin.forward_path_layer(self, input_array)
...
def reduce_min_default_implementation(
        old_layer: ReduceMin,
        version: str,
) -> ReduceMinDefault:
    """Create a Reduce_Min_Default layer using the parameters of old_layer."""
    return ReduceMinDefault(
        version=version,
        idx=old_layer.idx,
        size=old_layer.size,
        axis=old_layer.axes,
...
reduce_min_factory.register_implementation(
    None,
