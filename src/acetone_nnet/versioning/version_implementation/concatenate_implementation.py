"""Concatenate versioning manager.
...
from acetone_nnet.generator.layers.concatenate import Concatenate

ConcatenateVariant = Callable[[Concatenate, str], Concatenate]


class ConcatenateFactory:
...
concatenate_factory = ConcatenateFactory()
