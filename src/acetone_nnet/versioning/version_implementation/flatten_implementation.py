...
from acetone_nnet.generator.layers.flatten import Flatten

FlattenVariant = Callable[[Flatten, str], Flatten]


class FlattenFactory:
...
flatten_factory = FlattenFactory()
