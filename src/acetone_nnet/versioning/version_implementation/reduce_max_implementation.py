...
from acetone_nnet.generator.layers.reduce import ReduceMax

ReduceMaxVariant = Callable[[ReduceMax, str], ReduceMax]


class ReduceMaxFactory:
    """Build ReduceMax implementation layers."""

    def __init__(self) -> None:
        """Build default convolution layer factory."""
        self.implementations: dict[str | None, ReduceMaxVariant] = {
        }
...
reduce_max_factory = ReduceMaxFactory()
