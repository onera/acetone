...
from acetone_nnet.generator.layers.reduce import ReduceMin

ReduceMinVariant = Callable[[ReduceMin, str], ReduceMin]


class ReduceMinFactory:
...
reduce_min_factory = ReduceMinFactory()
