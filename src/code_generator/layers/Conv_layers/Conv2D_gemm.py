...
class Conv2D_gemm(Conv2D.Conv2D):
    ...
    def write_gemm_nn(self, m, n, k, A, B, C, direct):
        ...
        with open('src/templates/layers/template_Conv_gemm_nn.c.tpl','r') as template_file:
    ...
    def write_gemm_nt(self, m, n, k, A, B, C, direct):
        ...
        with open('src/templates/layers/template_Conv_gemm_nt.c.tpl','r') as template_file:
            template = template_file.read()
        template_file.close()
    ...
    def write_gemm_tn(self, m, n, k, A, B, C, direct):
        ...
        with open('src/templates/layers/template_Conv_gemm_tn.c.tpl','r') as template_file:
            template = template_file.read()
        template_file.close()
    ...
    def write_gemm_tt(self, m, n, k, A, B, C, direct):
        ...
        with open('src/templates/layers/template_Conv_gemm_tt.c.tpl','r') as template_file:
            template = template_file.read()
        template_file.close()
