...
class Conv2D_std_gemm(Conv2D_gemm.Conv2D_gemm):
    ...
    def write_im2col(self):
        ...
        with open('./src/templates/layers/Conv/template_im2col.c.tpl','r') as template_file:
    ...
    def write_im2row(self):
        ...
        with open('./src/templates/layers/Conv/template_im2row.c.tpl','r') as template_file:
            template = template_file.read()
        template_file.close()
    ...
    def generate_inference_code_layer(self):
        ...
        with open('./src/templates/layers/Conv/template_Conv_std_gemm.c.tpl','r') as template_file:
