...
#Input Layer
print('Input Layer')
l1 = acetone_nnet.InputLayer(idx=0,
                             size=300,
...
l4 = acetone_nnet.MaxPooling2D(idx=3,
                               size=300,
                               padding='same',
                               strides=1,
                               pool_size=3,
...
# Model JSON
print('Model JSON')
decr128 = acetone_nnet.CodeGenerator(model_path+"acas_decr128.json",None,'inference',1,'std_gemm_nn',False)

# Model H5
print('Model H5')
lenet5 = acetone_nnet.CodeGenerator(model_path+"lenet5_trained.h5",None,'inference',1,'std_gemm_nn',False)

# Model NNet
print('Model NNet')
acas_fully_connected = acetone_nnet.CodeGenerator(model_path+"acas_fully_connected.nnet",None,'inference',1,'std_gemm_nn',True)

# Model ONNX
print('Model ONNX')
squeezenet = acetone_nnet.CodeGenerator(model_path+"squeezenet1.onnx",None,'inference',1,'std_gemm_nn',False)
