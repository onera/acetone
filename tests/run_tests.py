...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        print(
            "Please enter the name of the test folder you want to run, or use all for testing all of them.",
        )
        print(
            'The argument can be the name of a directory containing test folders (ex: "test_layer" will run "test_c_python", "test_c_reference" and "test_without_template")',
        )
        test = input()
    else:
        test = sys.argv[1]
