...
class TestReduceMax(acetoneTestCase.AcetoneTestCase):
    """Test for ReduceMax Layer"""

    def testReduceMax_c(self):
        testshape = (1, 3, 10, 10)
    ...
    def testReduceMax_empty_noop_false(self):
        testshape = (1, 3, 10, 10)
    ...
    def testReduceMax_empty_noop_True(self):
        testshape = (1, 3, 10, 10)
    ...
    def testReduceMax_2DInputs(self):
        testshape = (10, 10)
