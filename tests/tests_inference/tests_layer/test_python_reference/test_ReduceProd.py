...
class TestReduceProd(acetoneTestCase.AcetoneTestCase):
    """Test for ReduceProd Layer"""

    def testReduceProd_c(self):
        testshape = (1, 3, 10, 10)
    ...
    def testReduceProd_empty_noop_false(self):
        testshape = (1, 3, 10, 10)
