...
class TestAcasFullyConnectedNNet(acetoneTestCase.AcetoneTestCase):
    """Inference test for Acas fully connected, NNet model."""

    def test_acas_fully_connected_nnet(self) -> None:
        """Tests Acas fully connected, NNet model, compare between NNet et C code."""
    ...
    def test_acas_fully_connected_nnet_python(self) -> None:
        """Tests Acas fully connected, NNet model, compare between python et C code."""
        model_path = (
                MODELS_DIR / "acas" / "acas_fully_connected" / "acas_fully_connected.nnet"
        )
        acetone_result = acetoneTestCase.run_acetone_for_test(
