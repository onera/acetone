...
class TestAcasFullyConnectedNNetNormalized(acetoneTestCase.AcetoneTestCase):
    ...
    def test_acas_fully_connected_normalized_nnet_python(self) -> None:
        """Tests Acas fully connected, NNet model with normalisation, compare between python et C code."""
        model_path = (
                MODELS_DIR / "acas" / "acas_fully_connected" / "acas_fully_connected.nnet"
        )
