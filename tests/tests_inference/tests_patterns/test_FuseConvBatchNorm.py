...
from keras.layers import BatchNormalization, Conv2D, Input, Add
...
class TestFuseConvBatchNormalization(acetoneTestCase.AcetoneTestCase):
    """Test for FuseConvBatchNormalization pattern."""

    def testFuseConvBatchNormalization2(self):
        testshape = (10, 10, 3)
        filters = 3
        kernel_size = (3, 3)
    ...
    def testFuseConvBatchNormalization1(self):
        testshape = (1, 3, 10, 10)
        ...
        graph = onnx.helper.make_graph(
            ...
            inputs=[X],
            outputs=[Y],
            initializer=[conv1_W_initializer_tensor, conv1_B_initializer_tensor, scale_initializer, bias_initializer,
                         mean_initializer, var_initializer],
        )
    ...
    def testFuseConvBatchNormalizationActiAfterConv(self):
        testshape = (10, 10, 3)
        filters = 3
        kernel_size = (3, 3)

        input = Input(testshape)
        x1 = Conv2D(filters=filters, kernel_size=kernel_size, activation="relu", bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(input)
        x2 = BatchNormalization(axis=-1, gamma_initializer="he_normal", beta_initializer="he_normal",
                                 moving_mean_initializer="he_normal", moving_variance_initializer="ones")(x1)
        x3 = Conv2D(filters=filters, kernel_size=kernel_size, activation=None, bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(x2)
        x4 = Conv2D(filters=filters, kernel_size=kernel_size, activation="tanh", bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(x3)
        x5 = BatchNormalization(axis=-1, gamma_initializer="he_normal", beta_initializer="he_normal",
                                 moving_mean_initializer="he_normal", moving_variance_initializer="ones")(x4)
        x6 = Conv2D(filters=filters, kernel_size=kernel_size, activation="silu", bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(x5)
        out = BatchNormalization(axis=-1, gamma_initializer="he_normal", beta_initializer="he_normal",
                                 moving_mean_initializer="he_normal", moving_variance_initializer="ones")(x6)
    ...
    def testFuseConvBatchNormalizationAddBeforeBatch(self):
        testshape = (10, 10, 3)
        filters = 3
        kernel_size = (3, 3)
        ...
        x3 = Conv2D(filters=filters, kernel_size=kernel_size, activation=None, bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(input)
        x4 = Conv2D(filters=filters, kernel_size=kernel_size, activation=None, bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(input)
        x5 = Add()([x3,x4])
        out = BatchNormalization(axis=-1, gamma_initializer="he_normal", beta_initializer="he_normal",
                                 moving_mean_initializer="he_normal", moving_variance_initializer="ones")(x5)
    ...
    def testFuseConvBatchNormalizationNotOnlyChild(self):
        testshape = (10, 10, 3)
        filters = 3
        kernel_size = (3, 3)
        ...
        x4 = Conv2D(filters=filters, kernel_size=kernel_size, activation="tanh", bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(x3)
        x5 = BatchNormalization(axis=-1, gamma_initializer="he_normal", beta_initializer="he_normal",
                                 moving_mean_initializer="he_normal", moving_variance_initializer="ones")(x2)
        x6 = Conv2D(filters=filters, kernel_size=kernel_size, activation="silu", bias_initializer="he_normal",
                    padding="same", data_format="channels_last")(x5)
        x7 = BatchNormalization(axis=-1, gamma_initializer="he_normal", beta_initializer="he_normal",
                                 moving_mean_initializer="he_normal", moving_variance_initializer="ones")(x6)
        out = Add()([x4,x7])
